  ...
  return (
    <Paper className="w-full rounded-20 shadow flex flex-col justify-between">
      ...
      <div className="text-center py-12">
        <Typography className="text-72 font-semibold leading-none text-gray tracking-tighter">
          {props.data.data.count}
        </Typography>
        <Typography className="text-18 font-normal text-gray-500">{props.data.data.name}</Typography>
      </div>
