...
import { uploadResponseImage } from '../../../../store/responseSlice';
        ...
        <div className="flex">
          <FormControl fullWidth>
            ...
            <Select
              ...
              value={style || 'default'}
              label="Image style"
              onChange={(event) => onDataChange({ target: { id: 'imageAspectRatio', value: event.target.value } })}
...
export function ImageEditor(props) {
  ...
  const uploadResult = useSelector(({ replyApp }) => replyApp.response.uploadResult);
  ...
  const handleFileInput = (event) => {
    ...
    dispatch(uploadResponseImage({ formData })).then((result) => {
