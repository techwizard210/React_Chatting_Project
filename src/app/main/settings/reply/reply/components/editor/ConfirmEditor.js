      ...
      <Paper variant="outlined" className="flex w-1/2 p-24 ">
        <div className="flex flex-col w-full space-y-1 ">
          <div className="flex flex-col space-y-16 items-center">
            ...
            />
            {/* <ActionEditor actionIndex={0} data={confirmData} responseIndex={responseIndex} response={response} />
            <ActionEditor actionIndex={1} data={confirmData} responseIndex={responseIndex} response={response} /> */}
            {confirmData.actions &&
              confirmData.actions.map((action, index) => (
                <ActionEditor
                  actionIndex={index}
