...
// import { markMentionRead, sendTeamChatMessage, sendTeamChatFileMessage } from '../../store/boardChatSlice';
...
//   const { selected, selectType } = useSelector(({ scrumboardApp }) => scrumboardApp.boardCurrent);
//   const customer = useSelector(({ scrumboardApp }) => scrumboardApp.customer.customer);
...
//     if (chatScrollRef.current && chatScrollRef.current.scrollHeight)
...
//                           if (mention) {
//                             textMessage = textMessage.replace(element, ` <a href="/users"><b><u>${name}</u></b></a> `);
//                           }
//                         });
//                       }
//                     }
...
//                               <ReadMoreContent text={textMessage} limit={30} />
//                             </div>
//                           )}
...
//             </FuseScrollbars>
//             {selected && (
//               <form onSubmit={onMessageSubmit} className="pb-16 px-8 absolute bottom-64 left-0 right-0">
