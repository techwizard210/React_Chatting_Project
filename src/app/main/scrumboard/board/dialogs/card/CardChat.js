...
import { sendMessage, sendFileMessage, getChatMessage } from '../../../store/boardChatSlice';
import { addSendingMessage } from '../../../store/boardCurrentSlice';
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="bubble flex relative items-center justify-center p-12 max-w-screen-sm shadow">
                        ...
                        {item.type && item.type === 'text' && <ReadMoreContent text={messageObj.text} limit={50} />}
                        <Typography
